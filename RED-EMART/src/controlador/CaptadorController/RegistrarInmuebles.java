...
public class RegistrarInmuebles {
    Bien_Inmueble bien = new Bien_Inmueble();
    Bien_InmuebleDAO dao = new Bien_InmuebleDAO();
    Direccion dic = new Direccion();
    DireccionDAO daoD = new DireccionDAO();
    Descripcion_BienInmueble desc = new Descripcion_BienInmueble();
    DescripcionDAO daoDes = new DescripcionDAO();
    private Integer ID;
