...
public class Bien_InmuebleDAO extends AdaptadorDao<Bien_Inmueble> {
    ...
    public static void main(String[] args) {
        ...
        try {
            inmueble.getInmueble().setId_Bien_Inmueble(1);
            inmueble.getInmueble().setId_direccion(2);
            inmueble.getInmueble().setId_estado_b("EB_D");
            inmueble.getInmueble().setId_descripcion(2);
            inmueble.getInmueble().setEncargado_Captador(0);
