...
public class PanelNuevoEmpleado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Text3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, -1, -1));
        ...
        jPanel1.add(NombreTxT, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 260, 30));

        jSeparator4.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator4.setPreferredSize(new java.awt.Dimension(200, 10));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 260, 10));

        Text6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text6.setText("Cargo");
        jPanel1.add(Text6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 40, -1));
        ...
        jPanel1.add(Text16, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, -1, -1));
        ...
        jPanel1.add(ApellidoTxT, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, 260, 30));

        jSeparator17.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator17.setPreferredSize(new java.awt.Dimension(200, 10));
        jPanel1.add(jSeparator17, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 260, 10));
        ...
        jPanel1.add(cargoComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 250, 260, 30));

        jSeparator18.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator18.setPreferredSize(new java.awt.Dimension(200, 10));
        jPanel1.add(jSeparator18, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, 260, 10));
