...
public class PanelConfiguracionEmpleado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(CrearNuevoAdminTxT, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 130, 170, 20));
    ...
    private void EditDatosLabelTxTMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditDatosLabelTxTMousePressed
        PanelAdmin pna = new PanelAdmin(Boolean.TRUE);
