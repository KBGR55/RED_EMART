...
public class PanelModificarCeo extends javax.swing.JPanel {
    ...
    public PanelModificarCeo(Boolean edit){
        initComponents();
        this.edit = edit;
        TitleUserTxT.setText("EDITAR ADMIN");
    ...
    private void initComponents() {
        ...
        TitleUserTxT.setText("MODIFICAR CEO");
        ...
        datosjlabel.setText("Datos informativos del Ceo");
