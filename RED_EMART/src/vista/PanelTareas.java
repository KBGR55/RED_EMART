...
public class PanelTareas extends javax.swing.JPanel {
    ...
    public PanelTareas(String rol) {
        initComponents();
        TitleUserTxT.setText("Su rol es: " + MayuscUser(rol));
    }
    ...
    private void initComponents() {
        ...
        TitleUserTxT.setText("Su rol es: Cap/Desp/Ceo");
        ...
        Text8.setText("Descripción sobre usted");
        Text8.setDoubleBuffered(true);
        add(Text8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 160, 20));
