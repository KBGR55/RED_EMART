...
public class PanelServicio extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        idInmuebleTxT = new javax.swing.JTextField();
        ...
        idClienteTxT.setForeground(new java.awt.Color(102, 102, 102));
        idClienteTxT.setText("Ingresar ID del Cliente");
        idClienteTxT.setBorder(null);
        idClienteTxT.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                idClienteTxTMousePressed(evt);
            }
        });
        jPanel3.add(idClienteTxT, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 210, 30));
        ...
        idInmuebleTxT.setBackground(new java.awt.Color(204, 204, 204));
        idInmuebleTxT.setForeground(new java.awt.Color(102, 102, 102));
        idInmuebleTxT.setText("Ingresar ID del Inmueble");
        idInmuebleTxT.setBorder(null);
        idInmuebleTxT.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                idInmuebleTxTMousePressed(evt);
            }
        });
        jPanel4.add(idInmuebleTxT, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 210, 30));
    ...
    private void idInmuebleTxTMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_idInmuebleTxTMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_idInmuebleTxTMousePressed
    ...
    private void idClienteTxTMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_idClienteTxTMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_idClienteTxTMousePressed
    ...
    private javax.swing.JTextField idInmuebleTxT;
