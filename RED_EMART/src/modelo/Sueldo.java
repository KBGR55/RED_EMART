...
public class Sueldo {
    ...
    private Double sueldo_mensualTotal;
    ...
    public Double getSueldo_mensualTotal() {
        return sueldo_mensualTotal;
    }

    public void setSueldo_mensualTotal(Double sueldo_mensualTotal) {
        this.sueldo_mensualTotal = sueldo_mensualTotal;
    }

    public Sueldo(Integer id_sueldo, Integer id_empleado, Date fecha_cobro, Double sueldo_mensual, Double monto_comisiones, Double sueldo_mensualTotal) {
        this.id_sueldo = id_sueldo;
        this.id_empleado = id_empleado;
        this.fecha_cobro = fecha_cobro;
        this.sueldo_mensual = sueldo_mensual;
