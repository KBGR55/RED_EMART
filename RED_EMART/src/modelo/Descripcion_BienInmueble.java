...
public class Descripcion_BienInmueble {
    ...
    public Descripcion_BienInmueble(Integer id_descripcion, Integer id_tipo_bien, Double metros_cuadrados, String color, Integer n_pisos, Integer n_cuartos, String amueblado, String ascensor, String piscina) {
        this.id_descripcion = id_descripcion;
        this.id_tipo_bien = id_tipo_bien;
        this.metros_cuadrados = metros_cuadrados;
        this.color = color;
